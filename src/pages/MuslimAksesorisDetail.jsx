...
const MuslimAksesorisDetail = () => {
  ...
  const productImages = [
    { src: '/assets/aksesoris/paket1.jpg', alt: 'Paket Muslim 1' },
    { src: '/assets/aksesoris/paket2.jpg', alt: 'Paket Muslim 2' },
    { src: '/assets/aksesoris/paket3.jpg', alt: 'Paket Muslim 3' }
  ]

  const products = [
    {
      name: 'Paket Muslim 1',
      description: 'Paket lengkap aksesoris muslim premium dengan gamis Rabbani',
      image: '/assets/aksesoris/paket1.jpg',
      items: ['Cookies', 'Sajadah pocket', 'Hijab my design series japan', 'Gamis Rabbani uk L']
    },
    {
      name: 'Paket Muslim 2',
      description: 'Paket aksesoris muslim dengan masker kain 3 lapis',
      image: '/assets/aksesoris/paket2.jpg',
      items: ['Cookies', 'Sajadah pocket', 'Hijab my design series japan', 'Masker kain 3 lapis']
    },
    {
      name: 'Paket Muslim 3',
      description: 'Paket aksesoris muslim dengan hijab polos ukuran 120',
      image: '/assets/aksesoris/paket3.jpg',
      items: ['Cookies', 'Sajadah pocket', 'Hijab polos ukuran 120', 'Masker kain 3 lapis']
    }
  ]
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3 md:gap-4">
              ...
              <div className="hidden sm:block">
                <h1 className="text-lg md:text-2xl font-bold">Muslim Aksesoris</h1>
                <p className="text-xs md:text-sm text-white/80">Premium Muslim Accessories</p>
              </div>
            </div>
      ...
      <div className="container mx-auto px-4 md:px-6 py-16">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
            Paket Muslim Aksesoris
            <span className="block text-primary">Premium dari Tokyo</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Paket lengkap aksesoris muslim berkualitas tinggi cocok untuk hadiah atau kebutuhan pribadi
          </p>
        </motion.div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
              ...
              >
                <div>
                  ...
                  <div className="mb-8">
                    <h4 className="text-lg font-bold text-gray-900 mb-4">Isi Paket:</h4>
                    <div className="space-y-3">
                      {currentProduct.items.map((item, idx) => (
                        <motion.div
                          key={idx}
                          initial={{ opacity: 0, x: -20 }}
                          animate={{ opacity: 1, x: 0 }}
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-center text-sm text-gray-500">
                    Fast response & Original Products
                  </p>
                </div>
              </motion.div>
            </div>
...
export default MuslimAksesorisDetail
